...
public class LogoFarwordTestCase extends BaseTestCase{
	
	public LogoFarwordTestCase() {
		super(IPUtil.getLocalIp(), 999999);
//		super(IPUtil.getTestServerIp(), 999999);
	}
	@Test
	public void test() {
		this.robot.actionJob(DefaultAction.instanceService(ServiceCode.Player_Logo_Farword), 2490149);
	}
