...
public class ZBuyMoneyPropAction extends BaseAction<ZGameRobot> {

	public ZBuyMoneyPropAction() {
//		super(BaseAction.主体行为, ServiceCode.GameManager_loadData);
		super(BaseAction.Random_Action, ServiceCode.ShopManager_buyMoneyProp);
	}
