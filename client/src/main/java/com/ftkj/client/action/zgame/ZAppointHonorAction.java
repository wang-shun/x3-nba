...
public class ZAppointHonorAction extends BaseAction<ZGameRobot> {

	public ZAppointHonorAction() {
//		super(BaseAction.主体行为, ServiceCode.GameManager_loadData);
		super(BaseAction.Main_Action, ServiceCode.LeagueHonorManager_appoint);
	}
