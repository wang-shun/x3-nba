...
public class ZScoutManager_showRollPlayer extends BaseAction<ZGameRobot> {
	
	
	public ZScoutManager_showRollPlayer() {
		super(BaseAction.Random_Action, ServiceCode.ScoutManager_showRollPlayer);
	}
