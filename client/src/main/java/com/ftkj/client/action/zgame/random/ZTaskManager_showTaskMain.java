...
public class ZTaskManager_showTaskMain extends BaseAction<ZGameRobot> {
	
	
	public ZTaskManager_showTaskMain() {
		super(BaseAction.Random_Action, ServiceCode.TaskManager_showTaskMain);
	}
