...
public class ZScoutManager_refreshScout extends BaseAction<ZGameRobot> {
	
	
	public ZScoutManager_refreshScout() {
		super(BaseAction.Random_Action, ServiceCode.ScoutManager_refreshScout);
	}
