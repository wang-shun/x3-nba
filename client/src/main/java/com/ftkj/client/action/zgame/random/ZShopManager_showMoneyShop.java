...
public class ZShopManager_showMoneyShop extends BaseAction<ZGameRobot> {
	
	
	public ZShopManager_showMoneyShop() {
		super(BaseAction.Random_Action, ServiceCode.ShopManager_showMoneyShop);
	}
